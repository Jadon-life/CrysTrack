...
export const ENVIRONMENT_BACKGROUND_POOL: EnvironmentBackgroundAsset[] = [
  { id: 'midnight-dubai-marina', src: '/api/backgrounds/midnight-dubai-marina', srcSet: '', objectPosition: '50% 48%', phases: ['night'], weather: ALL_WEATHER, slotStartMinute: 0, fallbackSrc: '/backgrounds/crystrack-golden-dubai.webp' },
  { id: 'predawn-misty-mountain-lake', src: '/api/backgrounds/predawn-misty-mountain-lake', srcSet: '', objectPosition: '50% 50%', phases: ['night', 'morning'], weather: ALL_WEATHER, slotStartMinute: 300, fallbackSrc: '/backgrounds/crystrack-golden-dubai.webp' },
  { id: 'sunrise-mountain-reflection', src: '/api/backgrounds/sunrise-mountain-reflection', srcSet: '', objectPosition: '50% 48%', phases: ['morning'], weather: ALL_WEATHER, slotStartMinute: 390, fallbackSrc: '/backgrounds/crystrack-golden-dubai.webp' },
  { id: 'morning-rocky-mountain-lake', src: '/api/backgrounds/morning-rocky-mountain-lake', srcSet: '', objectPosition: '50% 50%', phases: ['morning', 'day'], weather: ALL_WEATHER, slotStartMinute: 510, fallbackSrc: '/backgrounds/crystrack-day-urban-4k.webp' },
  { id: 'late-morning-swiss-lake', src: '/api/backgrounds/late-morning-swiss-lake', srcSet: '', objectPosition: '50% 50%', phases: ['day'], weather: ALL_WEATHER, slotStartMinute: 630, fallbackSrc: '/backgrounds/crystrack-day-urban-4k.webp' },
  { id: 'midday-green-highlands', src: '/api/backgrounds/midday-green-highlands', srcSet: '', objectPosition: '50% 50%', phases: ['day'], weather: ALL_WEATHER, slotStartMinute: 750, fallbackSrc: '/backgrounds/crystrack-day-urban-4k.webp' },
  { id: 'afternoon-dubai-business-bay', src: '/api/backgrounds/afternoon-dubai-business-bay', srcSet: '', objectPosition: '50% 50%', phases: ['day'], weather: ALL_WEATHER, slotStartMinute: 870, fallbackSrc: '/backgrounds/crystrack-day-urban-4k.webp' },
  { id: 'late-afternoon-downtown-dubai', src: '/api/backgrounds/late-afternoon-downtown-dubai', srcSet: '', objectPosition: '50% 48%', phases: ['day', 'golden'], weather: ALL_WEATHER, slotStartMinute: 960, fallbackSrc: '/backgrounds/crystrack-day-urban-4k.webp' },
  { id: 'golden-sheikh-zayed-road', src: '/api/backgrounds/golden-sheikh-zayed-road', srcSet: '', objectPosition: '50% 50%', phases: ['golden', 'evening'], weather: ALL_WEATHER, slotStartMinute: 1050, fallbackSrc: '/backgrounds/crystrack-golden-dubai.webp' },
  { id: 'sunset-dubai-skyline', src: '/api/backgrounds/sunset-dubai-skyline', srcSet: '', objectPosition: '50% 50%', phases: ['golden', 'evening'], weather: ALL_WEATHER, slotStartMinute: 1140, fallbackSrc: '/backgrounds/crystrack-golden-dubai.webp' },
  { id: 'blue-hour-downtown-dubai', src: '/api/backgrounds/blue-hour-downtown-dubai', srcSet: '', objectPosition: '50% 48%', phases: ['evening', 'night'], weather: ALL_WEATHER, slotStartMinute: 1230, fallbackSrc: '/backgrounds/crystrack-golden-dubai.webp' },
  { id: 'night-sheikh-zayed-dubai', src: '/api/backgrounds/night-sheikh-zayed-dubai', srcSet: '', objectPosition: '50% 48%', phases: ['night'], weather: ALL_WEATHER, slotStartMinute: 1350, fallbackSrc: '/backgrounds/crystrack-golden-dubai.webp' },
];
